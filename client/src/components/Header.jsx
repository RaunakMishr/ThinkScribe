    ...
    return(
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 txt-gray-700'>Your own <span className='text-primary'>blogging</span> <br /> platform.</h1>
                ...
                <form onSubmit={onSubmitHandler} className='flex hustify-between max-w-lg max-sm:scale-75 mx-auto borde border-gray-300 bg-white rounded overflow-hidden'>
