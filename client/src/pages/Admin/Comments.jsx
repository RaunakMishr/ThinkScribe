...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <table className='w-full text-sm teext-gray-500'>
        <thead className='text-xs text-gray-700 txt-left uppercase'>
          <tr>
            <th scope='col' className='px-6 py-3'> Blog Title & Comment</th>
            <th scope='col' className='px-6 py-3 max-sm:hidded'> Date</th>
